...
import { useGetMyPostsSuspenseInfiniteQuery } from '@/features/post/list/api/useGetMyPostsInfiniteQuery';
...
export function useCalendarView() {
  ...
  const { data, hasNextPage, fetchNextPage } = useGetMyPostsSuspenseInfiniteQuery();
